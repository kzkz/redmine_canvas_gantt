    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <h2 style={{ margin: 0, fontFamily: fontFamilies.ui, fontSize: '18px', fontWeight: 600, color: designTokens.textPrimary, display: 'flex', alignItems: 'center', gap: '8px' }}>
                        {questionIcon}
                ...
                >
                    <button
                        ...
                        style={{
                            ...
                            alignItems: 'center',
                            justifyContent: 'center',
                            backgroundColor: designTokens.buttonSecondaryBg,
                            border: 'none',
                            borderRadius: '9999px',
