    ...
    ({ parentId, onTasksCreated, hideStandaloneButton, showTopBorder = true, trackerOptions = [], defaultTrackerId, onContentChange }, ref) => {
        ...
        return (
            <div style={{
                ...
                borderTop: showTopBorder ? `1px solid ${designTokens.controlBorder}` : 'none',
                paddingTop: 8
            }}>
                <div
                    onClick={() => {
                    ...
                    <div style={{ paddingLeft: 16 }}>
                        <div
                            style={{
                                ...
                                padding: 4,
                                marginBottom: 10,
                                background: designTokens.buttonSecondaryBg,
                        ...
                        >
                            <button
                                ...
                                style={{
                                    ...
                                    border: 'none',
                                    borderRadius: 8,
                                    background: inputMode === 'table' ? designTokens.controlBg : 'transparent',
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    border: 'none',
                                    borderRadius: 8,
                                    background: inputMode === 'text' ? designTokens.controlBg : 'transparent',
                        ...
                        {inputMode === 'table' ? (
                            ...
                            <>
                                {trackerOptions.length > 0 && (
                                    <label style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10, color: designTokens.textSecondary, fontSize: 13, fontWeight: 600 }}>
                                ...
                                <textarea
                                    ...
                                    disabled={loading}
                                    rows={5}
                                    style={{ width: '100%', padding: 12, fontFamily: 'inherit', fontSize: 13, lineHeight: 1.5, color: designTokens.textSecondary, background: designTokens.controlBg, border: `1px solid ${designTokens.controlBorder}`, borderRadius: 8, resize: 'vertical', marginBottom: 8, boxSizing: 'border-box' }}
                                />
                            </>
                        )}
                        ...
                        {!hideStandaloneButton && (
                            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                                <button
                                    ...
                                    style={{
                                        padding: '6px 12px',
                                        background: loading || !hasSubjects() ? designTokens.controlBorderStrong : designTokens.brandPrimary,
                                        color: designTokens.buttonPrimaryFg,
                                        border: 'none',
                                        borderRadius: 4,
                                        fontSize: 13,
